            ...
            if not stock_data.empty:
                ...
                with st.container():
                    ...
                    with indicator_cols[0]:
                        ...
                        macd_fig.update_layout(height=300, margin=dict(l=10, r=10, t=30, b=10))
                    ...
                    with indicator_cols[1]:
                        ...
                        kdj_fig.update_layout(height=300, margin=dict(l=10, r=10, t=30, b=10))
                    ...
                    with indicator_cols[2]:
                        ...
                        rsi_fig.update_layout(height=300, margin=dict(l=10, r=10, t=30, b=10))
